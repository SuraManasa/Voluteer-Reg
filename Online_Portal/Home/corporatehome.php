...
<html>
    ...
    <div class="container">
        ...
        <form action="coorporateregistration.php" method="POST" enctype="multipart/form-data">
            <label>UPLOAD CSV</label>
        <input type="file" name="file" id="file" class="form-control"> <!-- it automatically creates file picker[button] -->
        ...
        $result=$conn->query($sql);
         if($result->num_rows) //if any row is present
         {
    
            while($row = $result->fetch_assoc()) // fetches for each row
            {
            echo '<tr>';
            echo '<td>' ;
